    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from-[#181c30] to-[#1a223f] py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl font-extrabold text-white mb-6 text-center">Social Media Marketing</h1>
          <p className="text-lg text-gray-300 mb-8 text-center">
            Build your brand and engage with customers on Facebook, Instagram, LinkedIn, and TikTok. We create content that converts.
          </p>
          <div className="bg-white/10 rounded-2xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              ...
              <li>Brand storytelling and visual design</li>
