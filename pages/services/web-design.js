    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from-[#181c30] to-[#1a223f] py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl font-extrabold text-white mb-6 text-center">Web Design & Development</h1>
          <p className="text-lg text-gray-300 mb-8 text-center">
            Create stunning, high-converting websites that look great and drive results. From design to launch, we handle everything.
          </p>
