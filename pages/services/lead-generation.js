      ...
      <div className="min-h-screen bg-gradient-to-b from-[#181c30] to-[#1a223f] py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-300 mb-8 text-center">
            Get qualified leads delivered to your inbox. Our proven system generates real customers for your business, not just website traffic.
          </p>
          <div className="bg-white/10 rounded-2xl p-8 mb-8">
            <h2 className="text-2xl font-bold text-white mb-4">What We Do</h2>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>Pay-per-lead campaigns</li>
              <li>Local business targeting</li>
              <li>Lead qualification and filtering</li>
